...
__all__ = [
    'PadBatch', 'BatchRandomResize', 'Gt2YoloTarget', 'Gt2Yolov5Target', 'Gt2FCOSTarget',
        ...
        for img_id, sample in enumerate(samples):
            ...
            for target_id in range(nt):
                ...
                # compute gt_label
                    ...
                    # for m, n, k in zip(a, gj, gi):
                    #     target[m, 4, n, k] += 1
                    sample['target{}'.format(i)][target_id, a, 4, gj, gi] = 1.
                    sample['target{}'.format(i)][target_id, a, 5 + c, gj, gi] = 1.
                    #print("target{}, feature{}, shape: ".format(target_id, i), gj.shape)
                    #print("target{}, feature{}, anchors: ".format(target_id, i), a)
                    #print("target{}, feature{}, gj: ".format(target_id, i), gj)
                    #print("target{}, feature{}, gi: ".format(target_id, i), gi)
                    #print("target{}, feature{}, class: ".format(target_id, i), c)
